...
detrange <- read.csv("mee313322-sup-0002-Supinfo1.csv") #set your working directory to where these datafiles are on your computer
head(detrange)
...
refdata <- read.csv("mee313322-sup-0003-Supinfo1.csv")
str(refdata)
